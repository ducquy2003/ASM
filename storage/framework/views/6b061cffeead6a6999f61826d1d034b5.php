            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('manageImages')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Images
                            </a>
                        </li>
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a gift code" style="margin-right: 20px;" class="check-all"
                                                    href="<?php echo e(route('add-image')); ?>"><i
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    <div style="margin-right: 27px;" class="check">
                                                        <?php echo e($image->id); ?></div>
                                                    <div class="categories-table-img">
                                                        <?php if($image->fileName == null): ?>
                                                            <i>NULL</i>
                                                        <?php else: ?>
                                                            <?php echo e($image->fileName); ?>
                                            ...
                                            <td>
                                                <?php if($image->filePath == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($image->filePath); ?>
                                            ...
                                            <td>
                                                <?php if($image->id_product == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($image->id_product); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($image->created_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <?php if($image->updated_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($image->updated_at); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-image/<?php echo e($image->id); ?>/<?php echo e(str_replace('/', '-', $image->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyImage', [$image->id, str_replace('/', '-', $image->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deleteImage', ['id' => $image->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/images/manageImages.blade.php ENDPATH**/ ?>
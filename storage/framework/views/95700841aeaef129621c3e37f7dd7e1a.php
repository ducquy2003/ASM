    ...
    <div class="page-flex">
            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('manageBrands')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Brands
                            </a>
                        </li>
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Manage Brand</h2>
                    <div class="col-lg-9">
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a cart" style="margin-right: 20px;" class="check-all"
                                                    href="<?php echo e(route('add-brand')); ?>"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($brand->created_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($brand->created_at); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($brand->updated_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($brand->updated_at); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-brand/<?php echo e($brand->id); ?>/<?php echo e(str_replace('/', '-', $brand->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyBrand', [$brand->id, str_replace('/', '-', $brand->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deleteBrand', ['id' => $brand->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/brands/manageBrand.blade.php ENDPATH**/ ?>
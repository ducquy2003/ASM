    ...
    <div class="page-flex">
            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        <li>
                            <a class="active" href="<?php echo e(url('dashboard')); ?>"><span class="icon home"
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <?php echo $__env->yieldContent('contentDashboard'); ?>
                </div>
            </main>
            <!-- ! Footer -->
            <footer class="footer">
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>
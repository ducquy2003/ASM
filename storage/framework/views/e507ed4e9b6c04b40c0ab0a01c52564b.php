    ...
    <div class="page-flex">
            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('manageGiftcodes')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Giftcode
                            </a>
                        </li>
        ...
        <div class="main-wrapper">
            ...
            <main class="main users chart-page" id="skip-target">
                <div class="container">
                    <h2 class="main-title">Manage Comment</h2>
                    <div class="col-lg-9">
                                    ...
                                    <tr class="users-table-info">
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a comment" style="margin-right: 20px;" class="check-all"
                                                    href="<?php echo e(route('add-comment')); ?>"><i
                                                        class="fa-solid fa-plus"></i></a>
                                                code
                                            </label>
                                        </th>
                                        <th style="    min-width: 120px;">content</th>
                                        <th style="    min-width: 120px;">post_time</th>
                                        <th style="    min-width: 120px;">id_user</th>
                                        <th style="    min-width: 120px;">id_products</th>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    <div style="margin-right: 27px;" class="check">
                                                        <?php echo e($comment->id); ?></div>
                                                    <div class="categories-table-img">
                                                        <?php if($comment->content == null): ?>
                                                            <i>NULL</i>
                                                        <?php else: ?>
                                            ...
                                            <td>
                                                <?php if($comment->post_time == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($comment->post_time); ?>
                                            ...
                                            <td>
                                                <?php if($comment->id_user == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($comment->id_user); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($comment->id_products == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($comment->id_products); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-comment/<?php echo e($comment->id); ?>/<?php echo e(str_replace('/', '-', $comment->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyComment', [$comment->id, str_replace('/', '-', $comment->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deleteComment', ['id' => $comment->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/comment/manageComment.blade.php ENDPATH**/ ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('quickCopy')); ?>" data-toggle="validator" novalidate="true"
                                    ...
                                    <?php if($category->id == $id): ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" name="description"><?php echo e($category->description); ?></textarea>
                                            </div>
                                        </div>
                                    <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/categories/copy.blade.php ENDPATH**/ ?>
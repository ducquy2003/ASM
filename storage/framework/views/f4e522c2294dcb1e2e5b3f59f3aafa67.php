        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="get" action="<?php echo e(route('addCate')); ?>" data-toggle="validator" novalidate="true">
                            <div class="row">
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/categories/add.blade.php ENDPATH**/ ?>
            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="" href="<?php echo e(route('manageOrders')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Orders
                            </a>
                        </li>
            ...
            <div class="sidebar-footer">
                <a href="##" class="sidebar-user">
                    <span class="sidebar-user-img">
                        <picture>
                            <source srcset="<?php echo e(asset('./img/avatar/avatar-illustrated-01.webp')); ?>" type="image/webp">
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a product" style="margin-right: 20px;"
                                                    class="check-all" href="<?php echo e(route('add-Product')); ?>"><i
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    <div style="margin-right: 27px;" class="check">
                                                        <?php echo e($product->id); ?></div>
                                                    <div class="categories-table-img">
                                                        <picture>
                                                            <source srcset="<?php echo e(asset('images/' . $product->image)); ?>"
                                                                type="image/webp"><img
                                                                src="<?php echo e(asset('images/' . $product->image)); ?>"
                                                                alt="category">
                                                        </picture>
                                                    </div>
                                                </label>
                                            ...
                                            <td>
                                                <?php if($product->storage == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->storage); ?>
                                            ...
                                            <td>
                                                <?php if($product->warranty_period == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->warranty_period); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->os == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->os); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->keyboard == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->keyboard); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->pin == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->pin); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->connector == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->connector); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->id_typeProduct == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->id_typeProduct); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->id_category == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->id_category); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($product->id_brand == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($product->id_brand); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-product/<?php echo e($product->id); ?>/<?php echo e(str_replace('/', '-', $product->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyPro', [$product->id, str_replace('/', '-', $product->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deletePro', ['id' => $product->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/product/manageProduct.blade.php ENDPATH**/ ?>
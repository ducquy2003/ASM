        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('editPro', $id)); ?>" data-toggle="validator" novalidate="true"
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/product/edit.blade.php ENDPATH**/ ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('quickCopyPro')); ?>" data-toggle="validator" novalidate="true"
                                                ...
                                                <select style="text-transform: capitalize;" class="form-control"
                                                    ...
                                                    <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($product->id_brand == $brand->id): ?>
                                                            <option value="<?php echo e($brand->id); ?>" hidden>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" required="" name="id_category"
                                                    ...
                                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($category->id == $product->id_category): ?>
                                                            <option value="<?php echo e($category->id); ?>" hidden>
                                                ...
                                                <select class="form-control" required="" name="id_typeProduct"
                                                    ...
                                                    <?php $__currentLoopData = $type_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($type_product->id == $product->id_typeProduct): ?>
                                                            <option value="<?php echo e($type_product->id); ?>" hidden>
                                                    ...
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php $__currentLoopData = $type_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($type_product->id); ?>">
                                                            <?php echo e($type_product->description); ?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Cost"
                                                    ...
                                                    value="<?php echo e($product->cost_old); ?>" name="cost_old">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Cost"
                                                    data-errors="Please Enter Cost." required=""
                                                    value="<?php echo e($product->cost); ?>" name="cost">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($product->connector); ?>">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter OS"
                                                    ...
                                                    value="<?php echo e($product->os); ?>" name="os">
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Keyboard" data-errors="Please Enter Price."
                                                    required="" value="<?php echo e($product->keyboard); ?>" name="keyboard">
                                                <input type="text" class="form-control" placeholder="Enter Pin"
                                                    data-errors="Please Enter Price." required=""
                                                    value="<?php echo e($product->pin); ?>" name="pin">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="<?php echo e($product->warranty_period); ?>" name="warranty_period">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/product/copy.blade.php ENDPATH**/ ?>
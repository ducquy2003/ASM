            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('manageAccounts')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Accounts
                            </a>
                        </li>
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a cart" style="margin-right: 20px;" class="check-all"
                                                    href="<?php echo e(route('add-account')); ?>"><i
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($account->password == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->password); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($account->is_admin == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->is_admin); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($account->gender == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <?php if($account->phone_number == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->phone_number); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($account->ban == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->ban); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($account->dob == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->dob); ?>
                                            ...
                                            <td>
                                                <?php if($account->avatar == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->avatar); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($account->description == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <?php if($account->id_giftcode == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->id_giftcode); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($account->created_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <?php if($account->updated_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($account->updated_at); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-account/<?php echo e($account->id); ?>/<?php echo e(str_replace('/', '-', $account->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyAccount', [$account->id, str_replace('/', '-', $account->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deleteAccount', ['id' => $account->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/accounts/manageAccount.blade.php ENDPATH**/ ?>
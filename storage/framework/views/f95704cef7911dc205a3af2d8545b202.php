            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('manageCarts')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Carts
                            </a>
                        </li>
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a cart" style="margin-right: 20px;" class="check-all"
                                                    href="<?php echo e(route('add-cart')); ?>"><i
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    <div style="margin-right: 27px;" class="check">
                                                        <?php echo e($cart->id); ?></div>
                                                    <div class="categories-table-img">
                                                        <?php if($cart->id_user == null): ?>
                                                            <i>NULL</i>
                                                        <?php else: ?>
                                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php if($cart->id_user == $account->id): ?>
                                            ...
                                            <td>
                                                <?php if($cart->created_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($cart->created_at); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($cart->updated_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($cart->updated_at); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-cart/<?php echo e($cart->id); ?>/<?php echo e(str_replace('/', '-', $cart->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyCart', [$cart->id, str_replace('/', '-', $cart->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deleteCart', ['id' => $cart->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/carts/manageCart.blade.php ENDPATH**/ ?>
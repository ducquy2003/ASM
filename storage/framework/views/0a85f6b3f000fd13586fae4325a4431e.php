...
<html lang="en">
    <head>
        <meta charset="utf-8">
          ...
          <link rel="stylesheet" href="<?php echo e(asset('/vendor/remixicon/fonts/remixicon.css')); ?>">  <style type="text/css">.apexcharts-canvas {
      position: relative;
      user-select: none;
                            ...
                            <div class="row">
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label>Content *</label>
                                        <input type="text" class="form-control" placeholder="Enter content" data-errors="Please Enter Name." required="">
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter post time" data-errors="Please Enter Name." required="">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label>ID User *</label>
                                        <input type="text" class="form-control" placeholder="Enter id user" data-errors="Please Enter Name." required="">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div> 
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter id product" data-errors="Please Enter Name." required="">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>                
                            </div>                       
                            <button type="submit" class="btn btn-primary mr-2 disabled">Add Comment</button>
...
</html><?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/comment/add.blade.php ENDPATH**/ ?>
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a gift code" style="margin-right: 20px;" class="check-all"
                                                    href="<?php echo e(route('add-giftCode')); ?>"><i
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $giftCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $giftCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    <div style="margin-right: 27px;" class="check">
                                                        <?php echo e($giftCode->id); ?></div>
                                                    <div class="categories-table-img">
                                                        <?php if($giftCode->code == null): ?>
                                                            <i>NULL</i>
                                                        <?php else: ?>
                                                            <?php echo e($giftCode->code); ?>
                                            ...
                                            <td>
                                                <?php if($giftCode->detail == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($giftCode->detail); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($giftCode->expired == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($giftCode->expired); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($giftCode->created_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($giftCode->created_at); ?>

                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($giftCode->updated_at == null): ?>
                                                    <i>NULL</i>
                                                <?php else: ?>
                                                    <?php echo e($giftCode->updated_at); ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-giftCode/<?php echo e($giftCode->id); ?>/<?php echo e(str_replace('/', '-', $giftCode->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyCart', [$giftCode->id, str_replace('/', '-', $giftCode->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('deleteCart', ['id' => $giftCode->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/giftcodes/manageGiftcode.blade.php ENDPATH**/ ?>
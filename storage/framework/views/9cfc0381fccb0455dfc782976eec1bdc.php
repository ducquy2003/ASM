            ...
            <div class="sidebar-start">
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo e(route('manageCategories')); ?>">
                                <span class="icon document" aria-hidden="true"></span>
                                Categories
                            </a>
                        </li>
                                        ...
                                        <th>
                                            <label class="users-table__checkbox ms-20">
                                                <a title="Add a category" style="margin-right: 20px;"
                                                    class="check-all" href="<?php echo e(route('add-category')); ?>"><i
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-category/<?php echo e($category->id); ?>/<?php echo e(str_replace('/', '-', $category->name)); ?>">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="<?php echo e(route('copyCate', [$category->id, str_replace('/', '-', $category->name)])); ?>">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="<?php echo e(route('delete', ['id' => $category->id])); ?>">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/categories/managecategories.blade.php ENDPATH**/ ?>
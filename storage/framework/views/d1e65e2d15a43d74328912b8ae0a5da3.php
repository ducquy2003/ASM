        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('addOrder')); ?>" data-toggle="validator" novalidate="true">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-md-6">
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/orders/add.blade.php ENDPATH**/ ?>
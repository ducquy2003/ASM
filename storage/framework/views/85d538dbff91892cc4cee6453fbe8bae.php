        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('addPro')); ?>" data-toggle="validator" novalidate="true" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select style="text-transform: capitalize;" class="form-control" required=""
                                            ...
                                            <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option style="text-transform: capitalize;" value="<?php echo e($brand->id); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" required="" name="id_typeProduct" id="">
                                            <?php $__currentLoopData = $type_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option value="<?php echo e($type_product->id); ?>"><?php echo e($type_product->description); ?>
...
<?php /**PATH C:\xampp\htdocs\group6\resources\views/pages/admin/product/add.blade.php ENDPATH**/ ?>
                                            ...
                                            <td>
                                                <span class="p-relative">
                                                    ...
                                                    <ul class="users-item-dropdown dropdown">
                                                        <li><a
                                                                href="update-comment/{{ $comment->id }}/{{ str_replace('/', '-', $comment->name) }}">Edit</a>
                                                        </li>
                                                        <li><a
                                                                href="{{ route('copyComment', [$comment->id, str_replace('/', '-', $comment->name)]) }}">Quick
                                                                Copy</a></li>
                                                        <li><a
                                                                href="{{ route('deleteComment', ['id' => $comment->id]) }}">Trash</a>
                                                        </li>
                                                    </ul>
                                                </span>
                                            </td>

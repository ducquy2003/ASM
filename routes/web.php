...
use App\Http\Controllers\admin\comment\manageComment_controller;
...
Route::get('manage-comment', [manageComment_controller::class, 'index'])
    ->name('manageComment')
    ->middleware('checkAdmin');

Route::get('add-comment', [manageComment_controller::class, 'addCommentView'])->name('add-comment')->middleware('checkAdmin');
Route::get('addComment', [manageComment_controller::class, 'addComment'])->name('addComment')->middleware('checkAdmin');

Route::get('update-comment/{id}/{name}', [manageComment_controller::class, 'updateComment'])->name('updateComment')->middleware('checkAdmin');
Route::post('editComment/{id}', [manageComment_controller::class, 'editComment'])->name('editComment')->middleware('checkAdmin');
Route::get('deleteComment/{id}', [manageComment_controller::class, 'deleteComment'])->name('deleteComment')->middleware('checkAdmin');

Route::get('add-comment-copy/{id}/{name}', [manageComment_controller::class, 'copyComment'])->name('copyComment')->middleware('checkAdmin');
Route::post('quickCopyComment', [manageComment_controller::class, 'quickCopyComment'])->name('quickCopyComment')->middleware('checkAdmin');
